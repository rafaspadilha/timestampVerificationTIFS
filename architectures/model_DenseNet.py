...
def buildModel(includeLocation=True, includeSatellite=True, outputTransientAttributes=True,
    ...
    groundBaseModel = DenseNet121(include_top=False, weights='imagenet', input_tensor=groundInput, pooling=None)
    ...
    if includeSatellite:
        ...
        aerialBaseModel = DenseNet121(include_top=False, weights='imagenet', input_tensor=aerialInput, pooling=None)
